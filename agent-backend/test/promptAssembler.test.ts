  ...
  character_voice_profiles: [
    {
      ...
      voice_description: 'Rhea description fulfilling length constraints.',
      tts_generation_prompt: 'Rhea prompt text for tests.',
      voice_name: 'Puck',
    },
    {
      ...
      voice_description: 'Mentor description with sufficient length.',
      tts_generation_prompt: 'Mentor prompt for tests.',
      voice_name: 'Deneb',
    },
  ],
