...
- Rename or alias the system prompt asset so developers interact with a `visual_reference_director` name that better matches the task’s intent while keeping the existing prompt content intact.
