...
- **Prompt encapsulation:** Reuse the existing Gemini client with a new prompt loader for `system_prompts/interactive_scriptwriter.md`; request payload construction lives in a pure helper to keep orchestration deterministic and testable.
