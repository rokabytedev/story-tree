...
- [x] 2.4 Add CLI commands for listing stories and showing a specific story.
...
- [x] 3.3 Extend automated coverage for list/show commands and document manual verification steps.
