...
## What Changes
- **Note**: The shot production system prompt (`system_prompts/shot_director.md`) has already been updated to generate the new output format with `audio_and_narrative` and `referenced_designs` fields. Do not modify this file.
...
- Keep the existing visual_renderer.md system prompt and reference image handling unchanged.
